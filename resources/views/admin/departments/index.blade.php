...
@section('content')
    ...
    <script type="text/javascript">
        ...
        departmentGridview.addColumn({
            ...
            'caption': 'عملیات',
            'type': ['html'],
            'typeData': '<a href="/admin/departments/{id}/edit" class="btn btn-info btn-sm update-item">ویرایش</a> <a href="/admin/departments/{id}/destroy" class="btn btn-danger btn-sm remove-item">حذف</a>',
            'visible': true,
            'sort': false,
            'filter': false,
            'beforeRender': function () {

...
@section('title', 'بازیابی رمز عبور | ' . config('app.name'))

@section('content')
<div class="w-full max-w-md">

    <div class="text-center mb-8">
        <h1 class="text-2xl font-bold text-gray-900">بازیابی رمز عبور</h1>
        <p class="mt-2 text-sm text-gray-500">لینک بازیابی به ایمیل شما ارسال می‌شود</p>
    </div>
    ...
    <p class="text-center mt-6 text-sm text-gray-500">
        <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-800 transition">&laquo; بازگشت به صفحه ورود</a>
    </p>
